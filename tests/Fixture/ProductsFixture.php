...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cat_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'cat_key' => ['type' => 'foreign', 'columns' => ['cat_id'], 'references' => ['category', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2022-04-23 07:50:45',
                'modified' => '2022-04-23 07:50:45',
            ],
        ];
        parent::init();
    }
